                        ...
                        <thead class="bg-gradient-to-r from-indigo-50 to-blue-50">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-center border border-gray-200 font-bold text-gray-700">SAW
                                    Score (Vi)</th>
                                <th class="px-4 py-3 text-center border border-gray-200 font-bold text-gray-700">Cost
                                </th>
                        ...
                        <tbody>
                            @foreach ($results as $result)
                                <tr class="{{ $result->ranking % 2 == 0 ? 'bg-white' : 'bg-gray-50' }}">
                                    <td class="px-4 py-3 border border-gray-200 font-semibold">{{ $result->ranking }}
                                    </td>
