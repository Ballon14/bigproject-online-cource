            ...
            <form action="{{ route('courses.update', $course->id) }}" method="POST" class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div
                        ...
                        <label for="nama_kursus" class="flex items-center gap-2 mb-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Full name of the course</p>
                            </div>
                        </label>
                    ...
                    <div
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="biaya" id="biaya"
                                value="{{ old('biaya', $course->biaya) }}" min="0" step="1"
                    ...
                    <div
                        ...
                        <input type="number" name="rating" id="rating" value="{{ old('rating', $course->rating) }}"
                    ...
                    <div
                        ...
                        <input type="number" name="durasi" id="durasi"
                            value="{{ old('durasi', $course->durasi) }}" min="0" step="1"
