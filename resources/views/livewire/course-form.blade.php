<div class="p-4 md:p-6 pt-0">
    ...
    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl shadow-lg p-6 mb-6">
        <div class="flex items-center gap-3 mb-2">
            ...
            <h2 class="text-2xl font-bold">{{ $isEditing ? 'Edit Course' : 'Add New Course' }}</h2>
        </div>
        <p class="text-blue-100 text-sm">
            {{ $isEditing ? 'Update course information below.' : 'Fill in the form below to add a new course to the SPK Online Courses system.' }}
        </p>
    </div>
    ...
    <x-success-modal title="Data Kursus Diperbarui" wire:model="showSuccessModal">
        Data kursus berhasil diperbarui!
    </x-success-modal>
        ...
        <form wire:submit="save" class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div
                    ...
                    <input type="text" wire:model="nama_kursus" id="nama_kursus"
                ...
                <div
                    ...
                    <div class="relative">
                        ...
                        <input type="number" wire:model="biaya" id="biaya" min="0" step="1"
                ...
                <div
                    ...
                    <input type="number" wire:model="rating" id="rating" min="0" max="5" step="0.1"
                ...
                <div
                    ...
                    <input type="number" wire:model="durasi" id="durasi" min="0" step="1"
                ...
                <div
                    ...
                    <select wire:model="fleksibilitas" id="fleksibilitas"
                ...
                <div
                    ...
                    <select wire:model="sertifikat" id="sertifikat"
                ...
                <div
                    ...
                    <select wire:model="update_terakhir" id="update_terakhir"
            ...
            <div class="mt-6 flex flex-col sm:flex-row gap-4">
                <button type="submit" wire:loading.attr="disabled"
                    class="flex-1 bg-gradient-to-r from-indigo-600 to-blue-600 text-white font-bold py-4 px-6 rounded-xl shadow-lg hover:from-indigo-700 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-all transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none">
                    <span class="flex items-center justify-center gap-2">
                        <svg wire:loading.remove wire:target="save" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        ...
                        <span wire:loading.remove wire:target="save">{{ $isEditing ? 'Update Course' : 'Save New Course' }}</span>
                        <span wire:loading wire:target="save">Saving...</span>
                    </span>
                </button>
                <a href="{{ $isEditing ? route('all-data') : route('dashboard') }}"
