<x-layout>
    ...
    <div class="p-4 md:p-6 pt-0">
        ...
        <div class="bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl shadow-lg p-6 mb-6">
            ...
            <p class="text-blue-100 text-sm">Fill in the form below to add a new course to the SPK Online Courses system.</p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-xl overflow-hidden">
            <form action="{{ route('input-data.store') }}" method="POST" class="p-6" x-data="{ submitting: false }" @submit="submitting = true">
                @csrf
                    ...
                    <div
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="biaya" id="biaya" value="{{ old('biaya') }}"
                                min="0" step="1"
                                class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all @error('biaya') border-red-500 @enderror"
                                placeholder="1500">
                ...
                <div class="mt-6 flex flex-col sm:flex-row gap-4">
                    <button type="submit"
                        ...
                        aria-label="Simpan kursus baru">
                        <span class="flex items-center justify-center gap-2">
                            <svg x-show="!submitting" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            ...
                            <span x-text="submitting ? 'Saving...' : 'Save New Course'"></span>
                        </span>
                    </button>
